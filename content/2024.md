...
<div class="row">
  <div>
    ...
    <p><center>
      Half-day (Morning Session, Meeting Room 217, Level 2 of Melbourne Convention and Exhibition Centre (MCEC)), <font size="3" color="red"> 1 Nov 2024, Melbourne</font> 
    </center></p>
  </div>
</div><br>
...
## Workshop Schedule
<div class="sched-div mb-2 center" id="Friday, Nov 1st">
          <h4 class="mt-0 mb-2 text-dark op-8 font-weight-bold">
            Friday, Nov 1st
          </h4>
          <p class="text-sm text-dark">
            Time zone:	AEDT <a href="https://www.timeanddate.com/time/zone/australia/melbourne">GMT + 11</a> <br>
            Location:  Meeting Room 217<br> Level 2 of Melbourne Convention and Exhibition Centre (MCEC)<br>
            <b>1 Convention Centre Place, South Wharf VIC 3006.</b> <br> 
            More details: <a href="https://2024.acmmm.org/full-program"> ACM MM full-program page</a><be>
<table class="table table-striped">
    <tbody>
        <tr>
