---
title: "MRAC: Multimodal, Generative and Responsible Affective Computing (4th International Workshop at ACM-Multimedia 2026)" 
date: 2026-04-04T00:06:56+08:00
---
...
<!--     <p><center>
    ...
    <p><center> -->
      Half-day  <font size="3" color="red"> TBD, 10–14 November 2026, Rio de Janeiro, Brazil</font> 
    </center></p>
  </div>
</div><br>
...
#### Submission 
We invite authors to submit unpublished papers (<a href="https://2026.acmmm.org/site/author-instructions.html" target="_blank">ACM-MM format</a>) to our workshop, to be presented at an oral/poster session upon acceptance. All submissions will go through a double-blind review process. All contributions must be submitted (along with supplementary materials, if any) at the <a href = "https://openreview.net/group?id=acmmm.org/ACMMM/2026/Workshop/MER&referrer=%5BHomepage%5D(%2F)#tab-your-consoles" target="_blank">Openreview</a> **with a note Track 2**. Accepted papers will be published in the official ACM-MM Workshops proceedings.
...
<table class="table table-striped">
    <tbody>
        <tr>
          ...
          <td> <del>June 30, 2026</del> July 19, 2026 (12:00 Pacific time)</td>
        </tr>
        <tr>
          <td>Notification to Authors</td>
          <td> <del>July 9, 2026</del> July 29, 2026</td>
        </tr>
        <tr>
          <td>Camera-Ready Deadline</td>
          <td>TBD (12:00 Pacific time)</td>
        </tr>
    </tbody>
</table>

#### Registration
Workshop registration will be handled by the ACM-MM-2026 main conference committee. Please follow the ACM-MM-2026 [website](https://2026.acmmm.org/site/registration.html) for related information.

In addition, ACM has started the Open Access publishing model. Please see the details here: [Website](https://2026.acmmm.org/site/calls-dates.html)
...
More details: [https://acmmm2026.org/information-for-presenters/](https://acmmm2026.org/information-for-presenters/) -->

## Workshop Schedule

#### TBD
Time zone:	Rio De Janeiro time [GMT -3 hour](https://www.timeanddate.com/time/zone/brazil/rio-de-janeiro)

Location: Coming soon

<!-- More details: [ACM MM full-program page](https://acmmm2026.org/acm-mm25-conference-agends/)-->
...
<div class="container p-0">
  <div class="row">
    ...
    <div class="col">
        <a href="https://research.monash.edu/en/persons/abhinav-dhall">
    ...
    <!-- <div class="col">
        <a href="https://scholar.google.com/citations?view_op=list_works&hl=en&hl=en&user=Wik3mXsAAAAJ&sortby=pubdate">
            <img class="organizer-pic" src="/2026/PG.jpeg">
        </a>
        <div class="people-name orgnizer-people-name">
            <a href="https://scholar.google.com/citations?view_op=list_works&hl=en&hl=en&user=Wik3mXsAAAAJ&sortby=pubdate">Parul Gupta</a>
            <h6 class="uni-name">Monash University</h6>
        </div>
    </div>   -->
    <div class="col">
...
<!-- <div class="container p-0">
    <div class="row row-cols-auto">  
      ...
      <div class="col-2 people-name"><a target="_blank" href="https://www.iiitb.ac.in/research-scholars/antara-roy-choudhury">Antara	Roy Choudhury</a><h6>IIIT Bangalore</h6></div>
      ...
      <div class="col-2 people-name"><a target="_blank" href="https://sites.google.com/view/gulshansharma">Gulshan Sharma</a><h6> New York University, Abu dhabi</h6></div>
      ...
      <div class="col-2 people-name"><a target="_blank" href="">Carles Ventura</a><h6>Universitat Oberta de Catalunya</h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Diana Tat </a><h6> Universitat Oberta de Catalunya </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Jakub	Januszkiewicz </a><h6> Warsaw University of Technology</h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Jialin	Li </a><h6> New York University, Abu Dhabi </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Mateusz	Trokielewicz </a><h6>  Warsaw University of Technology </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Meisam	Jamshidi Seikavandi </a><h6> IT University Of Copenhagen </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Niall	Murray </a><h6> Athlone Institute of Technology </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Pir Noman	Ahmad </a><h6> King Fahd University of Petroleum and Minerals College of Sciences </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Sk	Mohiuddin </a><h6> Asutosh College </h6></div>
      <div class="col-2 people-name"><a target="_blank" href=""> Ziyi	Ye </a><h6> Tsinghua University </h6></div>
...
<br>
Email: shreya.ghosh@ai.iitkgp.ac.in, Zhixi.Cai@monash.edu, abhinav.dhall@monash.edu
